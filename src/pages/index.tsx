...
import SocialDisplay, { TSocialForm } from "@/components/SocialDisplay";
...
export default function Home() {
  const [socialData, setSocialData] = useState<TSocialForm | null>(null);
  return (
    <>
      <Head>
      ...
      <main>
        <ThemeProvider theme={theme}>
          ...
          >
            <Box sx={{ maxWidth: "1248px", m: "auto" }}>
              <Header />
              {!socialData ? (
                <SocialForm
                  setData={(data: TSocialForm) => setSocialData(data)}
                />
              ) : (
                <SocialDisplay data={socialData} />
              )}
            </Box>
          </Box>
        </ThemeProvider>
